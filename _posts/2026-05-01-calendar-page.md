---
layout: post
title: ARCHER2 Calendar May 2026
...
<section id="service">
  <div class="container">
    ...
    {% assign year_imagecomp = site.imagecomp | where_exp: "imagecomp", "imagecomp.year == 2025 " %}

    {% assign entry_imagecomp = year_imagecomp | where_exp: "imagecomp", "imagecomp.entry_no == 03 " %}
...
{{ imagecomp.description }}
	...
	<p><i>This image was published on the May page of the ARCHER2 2026 printed calendar.  </i></p>
